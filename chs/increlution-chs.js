...
var cnItems = {
	...
	"This difficulty goes up by 2.50% with every completed action of the": "每完成一个动作，这个难度就会增加 2.50%",
	"This difficulty goes up by 5.00% with every completed action of the": "每完成一个动作，这个难度就会增加 5.00%",
	"This difficulty goes up by 7.50% with every completed action of the": "每完成一个动作，这个难度就会增加 7.50%",
	"combat type.": "战斗类型",
	"dodge type.": "闪避类型",
	"block type.": "格挡类型",
...
//    [/^(.+) health when eaten$/, '食用时恢复 $1 生命值'],
    ...
    [/^maximum health in your next generation \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?)$/, "最大生命值提供给您的下一代 (+$1",],
