...
var cnItems = {
    ...
    "Cooks 1 piece of bull meat per completion (+175 K health when eaten), requires bull meat to cook": "每次完成烹饪 1 块牛肉（食用时 +175 K 生命值），需要牛肉来烹饪",
...
//    [/^(.+) health when eaten$/, '食用时恢复 $1 生命值'],
    ...
    [/\+([\d\.]+) ([K|M|B|T]) health when eaten/, '食用时 +$1 $2 生命值'],
    [/\+([\d\.]+) health when eaten/, '食用时 +$1 生命值'],
    [/\+([\d\.]+)e([\d\.,]+) health when drunk/, '喝下时 +$1e$2 生命值'],
    [/\+([\d\.]+) ([K|M|B|T]) health when drunk/, '喝下时 +$1 $2 生命值'],
